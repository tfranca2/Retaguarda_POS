				...
				<div class="col-md-12">
				    <div class="form-group">
				        <div class="col-sm-4 col-md-offset-4">
				        	<br><button type="submit" disabled="disabled" class="btn btn-primary btn-lg btn-block" style="color: <?php echo $empresa->menu_color?>;background: <?php echo $empresa->menu_background?>; border-color: <?php echo $empresa->menu_background?>;">PAGAR</button>
				        </div>
				    </div>
				</div>
			</div>
