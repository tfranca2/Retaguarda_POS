			...
			<div class="panel-heading">
				...
				<div class="pull-right">
					<div class="btn-group">
						...
						<a href="<?php echo url('/'); ?>/premiacao/create" class="btn btn-info btn-xs"><span class="fa fa-plus"></span> Novo</a>
						@endif
					</div>
				</div>
			</div>
							...
							@forelse( $premiacoes as $premiacao )
								<tr>
									...
									<td class="text-center">
										...
										<a href="{{ url('/premiacao/'.$premiacao->id.'/edit') }}" class="btn btn-info" title="Editar"><i class="fa fa-pencil" aria-hidden="true"></i></a>
										@endif
										@if( Helper::temPermissao('cidades-excluir') )
										<form action="{{url('/premiacao/'.$premiacao->id)}}" method="POST" style="display: inline-block;">
											@method('DELETE') @csrf
